...
class Logger():
    ...
    def __init__(self, case_id, test_id, flock_size):
        ...
        if case_id == 'c':
            file_name = 'kinematic_simulation_copy/logs/data_' + case_id + '_' + str(flock_size) + '.csv'
            ...
            file_name = 'kinematic_simulation_copy/logs/data_' + case_id + '_' + str(test_id) +'.csv'
    ...
    def combine_files(self, prefix, nr_of_files, frame_duration):
        ...
        for i in range(nr_of_files):
            with open('kinematic_simulation_copy/logs/' + prefix + '_' + str(i) + '.csv','r') as csvfileQuick:
